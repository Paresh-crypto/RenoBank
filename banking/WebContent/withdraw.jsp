		...
		<div id="content">
			<center>
				...
				<%
					if (s.equals("true")) {
				%>
				<h2 style="color: red;">Withdraw Successfull!!</h2>
				<br />
				<%
					session.setAttribute("withdraw_status", "no_status");
							...
							if (s.equals("false")) {
				%>
				<h2 style="color: red;">Insufficient Amount!!</h2>
				<br />
				<%
					session.setAttribute("withdraw_status", "no_status");
							}
				...
				<br /> <img src="images/withdraw.jpg" width="550" height="300px" />
			</center>
		...
		<div id="aside">
			<p>
				* Online banking is the practice of making bank transactions or
				...
				<br />* Banking online allows a customer to make deposits,
				withdrawals, transfers with the click of a mouse. <br />
